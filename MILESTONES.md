...
| M13 | Visual craft pass — loading/empty states, micro-interactions, iconography, image placeholders, feedback consistency (on top of M12's tokens + M7's responsiveness, not a redo) | Not started |
| M14 | Functionality robustness pass — error-handling audit across server actions, form-validation completeness, double-submit prevention, closing out deferred QA findings (e.g. M6's "Cancel request on an already-completed booking" note) | Not started |
