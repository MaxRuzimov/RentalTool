...
| M15 | Availability blocking — surface already-approved-booking dates as blocked/unavailable on the "Request to rent" date picker, instead of only rejecting overlaps server-side after submit | In progress |
