...
export default function MyListingCard({ listing }: { listing: ListingCardData }) {
  ...
  return (
    <div className="flex items-center gap-4 rounded-2xl border border-black/[.08] bg-white p-4 dark:border-white/[.145] dark:bg-[#0a0a0a]">
      ...
      <div className="flex shrink-0 flex-col items-end gap-2 text-sm font-medium">
